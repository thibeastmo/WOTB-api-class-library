...
{
    public class Grouped_contacts
    {
        public List<int> blocked { get; private set; }
        public List<Tuple<object, object>> groups { get; private set; }
        public List<int> ignored { get; private set; }
        public List<int> muted { get; private set; }
        public List<int> ungrouped { get; private set; }
        public Grouped_contacts(Json json)
        {
            setValues(json);
            bool ok = true;
        }
